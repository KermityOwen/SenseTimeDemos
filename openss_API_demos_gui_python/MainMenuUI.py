...
"}")
        ...
        self.poseDemo.setObjectName(u"detectDemo_3")
        ...
        self.alignButton.clicked.connect(lambda: self.mainPages.setCurrentIndex(0))
        self.detectButton.clicked.connect(lambda: self.mainPages.setCurrentIndex(1))
        self.compareButton.clicked.connect(lambda: self.mainPages.setCurrentIndex(2))
        self.ocrButton.clicked.connect(lambda: self.mainPages.setCurrentIndex(3))
        self.poseButton.clicked.connect(lambda: self.mainPages.setCurrentIndex(4))

        self.alignDemo.clicked.connect(lambda: MainWindow.loadAPIDemo(demo_type="alignment"))
        self.detectDemo.clicked.connect(lambda: MainWindow.loadAPIDemo(demo_type="detect"))
        self.compareDemo.clicked.connect(lambda: MainWindow.loadAPIDemo(demo_type="compare"))
        self.poseDemo.clicked.connect(lambda: MainWindow.loadAPIDemo(demo_type="pose"))
